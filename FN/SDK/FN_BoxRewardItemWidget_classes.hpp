...
// WidgetBlueprintGeneratedClass BoxRewardItemWidget.BoxRewardItemWidget_C
// 0x000C (0x0214 - 0x0208)
class UBoxRewardItemWidget_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BoxRewardItemWidget.BoxRewardItemWidget_C");
		return ptr;
	}


	void CreateRewardItem(int RewardItem, int Type, class UTexture2D* icon, int Level, class URewardItemWidget_C** NewItem);
};
