...
// WidgetBlueprintGeneratedClass CharacterConfigTileWidget.CharacterConfigTileWidget_C
// 0x0030 (0x0238 - 0x0208)
class UCharacterConfigTileWidget_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CharacterConfigTileWidget.CharacterConfigTileWidget_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_CharacterConfigTileWidget(int EntryPoint);
};
