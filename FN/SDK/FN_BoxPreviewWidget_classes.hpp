...
// WidgetBlueprintGeneratedClass BoxPreviewWidget.BoxPreviewWidget_C
// 0x0018 (0x0220 - 0x0208)
class UBoxPreviewWidget_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BoxPreviewWidget.BoxPreviewWidget_C");
		return ptr;
	}


	void SetInfo(const struct FString& Name, class UTexture2D* icon);
	void ExecuteUbergraph_BoxPreviewWidget(int EntryPoint);
};
